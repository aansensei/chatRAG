...
_SYSTEM_EN = (
    ...
    "STRICT RULE: Your answer must be based ENTIRELY on the document context provided below. "
    "Do NOT guess, infer, or fabricate names, project names, or figures that are not in the context. "
    "If context contains partial information: cite exactly what is present and explicitly state what is not mentioned. "
...
_SYSTEM_VI = (
    ...
    "QUY TẮC NGHIÊM: Câu trả lời phải dựa HOÀN TOÀN vào nội dung context bên dưới. "
    "KHÔNG đoán, KHÔNG suy diễn, KHÔNG bịa tên người, tên dự án, con số ngoài context. "
